...
function Linux:CreateWindow(title, subtitle)
    local window = {}
        ...
        function tab:AddDropdown(id, config)
            ...
            local function updateDropdownFrame()
                ...
                for i, value in pairs(values) do
                    ...
                    option.MouseButton1Click:Connect(function()
                        ...
                        isOpen = false
                        TweenService:Create(dropdownFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {Size = UDim2.new(1, 0, 0, 0)}):Play()
            ...
            button.MouseButton1Click:Connect(function()
                ...
                if isOpen then
                    ...
                    TweenService:Create(dropdownFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {Size = UDim2.new(1, 0, 0, #values * 27)}):Play()
                else
                    TweenService:Create(dropdownFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {Size = UDim2.new(1, 0, 0, 0)}):Play()
                    task.delay(0.3, function() dropdownFrame.Visible = false end)
                end
            ...
            return {
                SetValues = function(newValues)
                    ...
                    updateDropdownFrame()
                    if isOpen then
                        dropdownFrame.Size = UDim2.new(1, 0, 0, #values * 27)
                    end
                end,
